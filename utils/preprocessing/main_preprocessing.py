from utils.preprocessing.processes.analyze_data import analyze_data
from utils.preprocessing.processes.create_index import create_index
from utils.preprocessing.processes.optimize_data import optimize_data
